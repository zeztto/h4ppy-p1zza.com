...
export const projects: Project[] = [
  ...
  // NEW: Lottery Roulette - Games
  {
    ...
    features: [
      'Web Crypto API + Rejection Sampling 기반 공정 추첨',
      '한번에 추첨 / 순차 추첨 / 자동 연속 추첨',
      '추첨 번호 개수, 당첨자 수, 중복 허용 여부 설정',
      'S 추첨 / R 리셋 키보드 단축키',
      'Canvas 기반 룰렛 휠과 당첨 콘페티 피드백',
      '외부 사이트 iframe 임베드 지원',
      '66개 테스트 케이스와 입력 검증 로직',
    ],
    techStack: [
      'React',
      'TypeScript',
