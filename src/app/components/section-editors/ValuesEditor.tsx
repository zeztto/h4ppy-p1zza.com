...
interface ValuesEditorProps {
  ...
  sectionId: string;
  onSave: (content: ValuesContent) => void;
  onClose: () => void;
}

export function ValuesEditor({ content, onSave, onClose }: ValuesEditorProps) {
    ...
    <>
      ...
      <div className="fixed inset-y-0 right-0 w-full max-w-lg bg-background border-l border-border shadow-xl z-50 flex flex-col">
        <div className="flex items-center justify-between p-4 border-b border-border">
          <h2 className="text-lg font-semibold">핵심 가치 편집</h2>
